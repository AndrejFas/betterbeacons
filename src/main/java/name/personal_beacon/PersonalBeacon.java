...
import name.personal_beacon.item.BeaconMedaillon;
import name.personal_beacon.item.BeaconTrinketItem;
import name.personal_beacon.component.ModDataComponents;
import name.personal_beacon.item.DragonLeather;
import name.personal_beacon.screen.BeaconTrinketScreenHandler;
...
public class PersonalBeacon implements ModInitializer {
	public static final String MOD_ID = "personal_beacon";
	public static PersonalBeaconConfig CONFIG;

	public static final Identifier OPEN_GUI_PACKET_ID = Identifier.of("personal_beacon", "open_gui");
