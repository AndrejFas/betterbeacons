package name.personal_beacon.client.gui;

import name.personal_beacon.PersonalBeacon;
...
public class BeaconTrinketScreen extends HandledScreen<BeaconTrinketScreenHandler> {
    ...
    private static final Identifier TEXTURE = Identifier.of("personal_beacon", "textures/gui/container/pocket_beacon.png");
    private static final Identifier ICONS = Identifier.of("personal_beacon", "textures/gui/icons.png");
