...
import name.personal_beacon.OpenBeaconTrinketPayload;
import name.personal_beacon.client.gui.BeaconTrinketScreen;
...
public class PersonalBeaconClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		openTrinketGuiKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
				"key.personal_beacon.open_gui", // Translation key
				InputUtil.Type.KEYSYM,
				GLFW.GLFW_KEY_G, // Default key
				"category.personal_beacon" // Category in controls menu
		));
